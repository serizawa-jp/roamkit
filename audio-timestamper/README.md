...
```javascript
 ...
 s.src = "https://cdn.jsdelivr.net/gh/serizawa-jp/roamkit@main/audio-timestamper/audio-timestamper.js";
 document.getElementsByTagName("head")[0].appendChild(s);
```

## Acknowledgments

The main logic of this script was copied from https://c3founder.github.io/Roam-Enhancement/. Many thanks to c3founder.
