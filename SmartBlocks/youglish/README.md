...
tag.src = "https://cdn.jsdelivr.net/gh/serizawa-jp/roamkit@main/roamkit/dist/roam-kit.min.js";
...
const timestamp = `${tsStr} ${highlight(decodeURIComponent(captionEvent.caption))}`;
